...
function AddInstrument() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://main-backend-agrikart.vercel.app/api/equipment', {
        method: 'POST',
...
<div className="min-h-screen bg-gray-100 py-8">
      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="space-y-4">
          ...
          {/* Number Plate Number */}
          <div>
            <label className="block text-sm font-medium text-gray-700">Number Plate Number</label>
            <input
              type="text"
          ...
          <div className="flex items-center">
            ...
            />
            <label className="ml-2 block text-sm text-gray-900">Is Vehicle</label>
          </div>
