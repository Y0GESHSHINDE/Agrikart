...
const EquipmentCard = ({ instrument, viewMode, onEdit, onDelete }) => {
  return (
    <div
      ...
      <div
        ...
        <div
          className={`${
            viewMode === "list"
              ? "sm:mt-1 sm:flex sm:items-center sm:justify-center"
              : "my-3"
        ...
        <div
          className={`flex items-center rounded-lg border border-gray-100 px-3 py-2 text-xs sm:text-sm text-gray-600 hover:border-gray-200 transition-colors ${
            viewMode === "list" ? "mt-4 mb-2" : "my-4"
          }`}>
        ...
        <div
          className={`flex flex-wrap items-center ${
            viewMode === "list" ? "justify-end gap-4" : "justify-between gap-3"
          } mt-4`}>
          <button
